package com.example.studywithme.comment.controller;

import com.example.studywithme.comment.service.CommentService;
import com.example.studywithme.comment.service.CommentService.CommentResponse;
...
public class CommentApiController {
    ...
    private final com.example.studywithme.user.service.UserActivityService userActivityService;
    ...
    public List<CommentResponse> getComments(@PathVariable Long postId,
        ...
        if (loginUser instanceof com.example.studywithme.user.entity.User user) {
            userId = user.getId();
        }
    ...
    public Map<String, Object> addComment(@PathVariable Long postId,
        ...
        var loginUser = (com.example.studywithme.user.entity.User) session.getAttribute("loginUser");
        if (loginUser == null) {
