...
2025년 이후부터 끊임없이 학습하며 도전하는 사람들이 늘고있는만큼, 어플리케이션에 쌓이는 정보와 데이터들은 너무나 방대합니다. 그 정보들을 일일히 찾지않고 개인 AI툴이 항상 작동하여 어플리케이션 이동시, 본인의 학습 로드맵을 직접 짜주고
유사도를 계산하여 유저 친화적인 어플리케이션을 개발합니다.
